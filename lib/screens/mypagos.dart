...
import 'package:vnbingo/utils/metamask.dart';

class MyPagos extends StatefulWidget {
  const MyPagos({Key? key}) : super(key: key);

  @override
  State<MyPagos> createState() => _MyPagosState();
}

class _MyPagosState extends State<MyPagos> {
  @override
